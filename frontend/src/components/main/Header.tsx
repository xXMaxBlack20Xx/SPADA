...
// Componente HeaderAesthetic
export default function HeaderAesthetic() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      <div className="w-full bg-gradient-to-b from-[#0B0A17] via-[#121024] to-[#1A132B]/95 backdrop-blur supports-[backdrop-filter]:backdrop-blur-md shadow-lg border-b border-white/10">
