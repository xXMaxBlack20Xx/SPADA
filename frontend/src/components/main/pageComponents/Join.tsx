...
> = {
    ...
    en: {
        ...
        subtitle: 'Start right away and try our sports prediction platform completely free.',
        cta: 'Join SPADA',
    },
    zh: {
        title: '开始非常简单',
...
export default function Join({ className = '' }: JoinProps): JSX.Element {
        ...
        >
            <div className="mx-auto max-w-6xl relative isolate overflow-hidden rounded-3xl bg-[#1a1d21] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10 shadow-[0_12px_40px_rgba(168,85,247,0.15)]">
                ...
                <div className="max-w-xl">
                    ...
                    <p className="text-white/80 text-base md:text-lg mb-8">{t.subtitle}</p>

                    <a
                        href="#signup"
                        className="inline-flex items-center justify-center px-6 py-3 rounded-xl text-sm font-semibold bg-linear-to-r from-[#F97316] via-[#7C3AED] to-[#A855F7] hover:brightness-110 transition shadow-[0_0_24px_rgba(249,115,22,0.25)]"
                    >
                        {t.cta}
                    </a>
                </div>
            ...
            <div
                aria-hidden
                className="absolute top-0 left-0 right-0 h-0.5 bg-linear-to-r from-[#7C3AED] via-[#A855F7] to-[#F97316] opacity-60"
            />
        </section>
    );
}
