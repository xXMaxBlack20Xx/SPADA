...
import { useLanguage } from "../../../context/LanguageContext"; // ← ajusta la ruta si es necesario
...
> = {
  es: {
    ...
    body: (
      <>
        SPADA es una plataforma inteligente que analiza miles de datos en tiempo
        real para ofrecerte predicciones precisas sobre partidos de la{" "}
        <span className="font-semibold">NBA</span>,{" "}
        <span className="font-semibold">NFL</span> y{" "}
        <span className="font-semibold">MLB</span>. No necesitas pagar: con solo
        registrarte accedes a análisis confiables y detallados. SPADA nació para
        democratizar la información deportiva y ayudarte a entender mejor cada
        juego.
      </>
    ),
  ...
  en: {
    ...
    body: (
      <>
        SPADA is an intelligent platform that analyzes thousands of data points
        in real time to deliver accurate predictions for{" "}
        <span className="font-semibold">NBA</span>,{" "}
        <span className="font-semibold">NFL</span>, and{" "}
        <span className="font-semibold">MLB</span> games. You don’t need to
        pay—just register to access trustworthy, in-depth analysis. SPADA was
        built to democratize sports information and help you understand every
        game better.
      </>
    ),
