    ...
    return (
        <section
            ...
            className="relative isolate min-h-[92vh] pt-28 flex items-center overflow-hidden
                 bg-linear-to-b from-[#0B0A17] via-[#121024] to-[#1A132B]"
        ...
        >
            ...
            <div aria-hidden className="pointer-events-none absolute inset-0">
                {/* Halo central */}
                <div
                    className="absolute -inset-x-32 top-16 h-152 blur-3xl opacity-40
                     bg-[radial-gradient(60rem_30rem_at_50%_0%,rgba(168,85,247,0.35),transparent_60%)]"
                />
                {/* Barrido diagonal */}
                <div
                    className="absolute -right-32 top-24 w-240 h-240 rotate-12 blur-2xl opacity-20
                ...
                <div
                    className="absolute top-0 left-0 right-0 h-0.5
                     bg-linear-to-r from-[#7C3AED] via-[#A855F7] to-[#F97316] opacity-60"
                />
            </div>
            ...
            <div className="relative z-10 mx-auto w-full max-w-5xl px-6 text-center">
                ...
                >
                    <span className="inline-block h-1.5 w-1.5 rounded-full bg-linear-to-r from-[#A855F7] to-[#F97316] shadow-[0_0_10px_2px_rgba(249,115,22,0.35)]" />
                    {t.brandTag}
                </div>
                ...
                >
                    <span className="relative inline-block">
                        ...
                        <span
                         ...
                         bg-linear-to-r from-[#A855F7] via-[#7C3AED] to-[#F97316]
                         blur-[2px] opacity-80"
                        />
                        {/* Shimmer */}
                        <span
                ...
                <div className="mt-8 flex flex-wrap items-center justify-center gap-3 animate-fade-up delay-300">
                    <a
                       ...
                       bg-linear-to-r from-[#F97316] via-[#7C3AED] to-[#A855F7]
