...
export default function PerformanceTab({ predictions }: PerformanceTabProps) {
    ...
    const stats = useMemo(() => {
        ...
        completedGames.forEach((game) => {
            ...
            const predictedWinner =
                game.predicted_home_win === 1 ? game.home_team : game.away_team;
            const actualWinner =
            ...
            const spread =
                typeof game.spread_line === 'string'
                ...
                {completedGames.length === 0 ? (
                    ...
                    <div className="space-y-4">
                        {completedGames
                            .sort(
                                (a, b) =>
                                    new Date(b.gameday).getTime() -
                                    new Date(a.gameday).getTime(),
                            )
                            .map((game) => {
